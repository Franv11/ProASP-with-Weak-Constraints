...
namespace aspc
{
    ...
    public:
        ...
        // NEW RULES FOR WEAK
        Rule(const std::vector<aspc::Atom> &head, const std::vector<aspc::Literal> &body, const std::string weight, const std::string level, const std::set<std::string> termsInWhichPay);
        Rule(const std::vector<aspc::Atom> &head, const std::vector<aspc::Literal> &body, const std::vector<aspc::ArithmeticRelation> &arithmeticRelations, const std::vector<aspc::ArithmeticRelationWithAggregate> &arithmeticRelationsWithAggregate, const std::string weight, const std::string level, const std::set<std::string> termsInWhichPay);
