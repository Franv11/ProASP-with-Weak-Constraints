...
public:
    ~WeakPropagator() {}
    WeakPropagator() : actualSum(0), undefSum(0), upperBound(-1), enabled(false) {}
    ...
    int getActualSum() const { return actualSum; }

    void    enabledPropagator() { enabled = true; }
