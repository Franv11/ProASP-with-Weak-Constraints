...
public:
    ...
    TupleLight(const std::initializer_list<int> &l, bool negated = false, int waspID = 0) : /*std::vector<int>(l),*/ size_(l.size()), predicateName(-1), id(0), status(UNKNOWN), collisionsListsSize(0), collisionsLists(nullptr)
    {
        content = new int[l.size()];
        std::copy(l.begin(), l.end(), content);
    }

    TupleLight(const std::initializer_list<int> &l, int predicateName, bool negated = false, int waspID = 0) : /*vector<int>(l),*/ size_(l.size()), predicateName(predicateName), id(0), status(UNKNOWN), collisionsListsSize(0), collisionsLists(nullptr)
    {
        content = new int[l.size()];
        std::copy(l.begin(), l.end(), content);
    }

    TupleLight(const std::vector<int> &l, int predicateName, bool negated = false, int waspID = 0) : /*vector<int>(l),*/ size_(l.size()), predicateName(predicateName), id(0), status(UNKNOWN), collisionsListsSize(0), collisionsLists(nullptr)
    {
        content = new int[l.size()];
        std::copy(l.begin(), l.end(), content);
    }
    ...
    TupleLight(int *l, int size, int predicateName, bool negated = false, int waspID = 0) : /*vector<int>(l),*/ size_(size), predicateName(predicateName), id(0), status(UNKNOWN), collisionsListsSize(0), collisionsLists(nullptr)
    {
        content = l;
    }
    TupleLight(const std::vector<int> &l, bool negated = false, int waspID = 0) : /*vector<int>(l),*/ size_(l.size()), id(0), status(UNKNOWN), collisionsListsSize(0), collisionsLists(nullptr)
    {
        content = new int[l.size()];
        std::copy(l.begin(), l.end(), content);
    }
