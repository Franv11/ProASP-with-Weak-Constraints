...
namespace aspc
{
    ...
    public:
        ...
        void addWeakConstraint(const aspc::Rule &w);
        void addRewrittenWeak(const aspc::Rule &rW);

        unsigned getReWrittenWeakSize() const;
        const std::vector<aspc::Rule> &getRewrittenWeak() const;
        const aspc::Rule &getRewrittenWeak(unsigned i) const;
        std::set<std::string> getHeadRewrittenRule() const;

        unsigned getWeakSize() const;
        const std::vector<aspc::Rule> &getWeak() const;
        const aspc::Rule &getWeak(unsigned i) const;
    ...
    private:
        ...
        std::vector<aspc::Rule> weakConstraints;
        std::vector<aspc::Rule> reWrittenWeaks;
